...
@click.option("--output-types", type=click.Path(), help="File to output combined inferred types as JSON.")
@click.option("--output-log", type=click.Path(), help="File to output combined inference log.")
@click.option(
    "--log-level",
    default="off",
    show_default=True,
